  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed inset-y-0 left-0 w-64 bg-surface-950/90 backdrop-blur-xl border-r border-white/5 flex flex-col z-[110]"
      >
        ...
        <div className="p-4 border-t border-surface-800">
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={logout}
              className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-400 hover:text-red-300 transition-colors border border-red-500/20"
            >
